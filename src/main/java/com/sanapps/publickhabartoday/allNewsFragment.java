...
public class allNewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = rootview.findViewById(R.id.allnews_reView);
        pkt_shimmer = rootview.findViewById(R.id.allnews_shimmerlayout);

        nestedScrollView = rootview.findViewById(R.id.nested_view);
    ...
    private void getAllPosts() {
        ...
        String url = "Your Api for the all posts";
