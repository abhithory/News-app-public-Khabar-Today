...
public class bhadraFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_bhadra, container, false);
        recyclerView = rootview.findViewById(R.id.bhadra_reView);
        pkt_shimmer = rootview.findViewById(R.id.bhadra_shimmerlayout);

        nestedScrollView = rootview.findViewById(R.id.nested_view_bhadra);
    ...
    private void getAllPosts() {
        ...
        String url = "Your Api for the all posts where tag is bhadra";
