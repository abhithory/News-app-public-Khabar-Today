...
public class haryanaFragment extends Fragment {
    ...
    View rootview = inflater.inflate(R.layout.fragment_haryana, container, false);

        recyclerView = rootview.findViewById(R.id.haryana_reView);
        pkt_shimmer = rootview.findViewById(R.id.haryana_shimmerlayout);

        nestedScrollView = rootview.findViewById(R.id.nested_view_haryana);
    ...
    private void getAllPosts() {
        ...
        String url = "Your Api for the all posts where tag is haryana";
