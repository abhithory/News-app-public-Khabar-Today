...
public class indiaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = rootview.findViewById(R.id.india_reView);
        pkt_shimmer = rootview.findViewById(R.id.india_shimmerlayout);

        nestedScrollView = rootview.findViewById(R.id.nested_view_india);
    ...
    private void getAllPosts() {
        ...
        String url = "Your Api for the all posts where tag is india";
