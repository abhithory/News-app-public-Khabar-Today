...
public class rajasthanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = rootview.findViewById(R.id.raj_reView);
        pkt_shimmer = rootview.findViewById(R.id.raj_shimmerlayout);

        nestedScrollView = rootview.findViewById(R.id.nested_view_raj);
